...
class MainDialog extends LogoutDialog {
    ...
    async graph(context,next){
        ...
        switch (command) {
            case 'me':
                await OAuthHelpers.listMe(context, tokenResponse);
                break;
            case 'recent':
                await OAuthHelpers.listRecentMail(context, tokenResponse);
                break;
            case 'myemail':
                await OAuthHelpers.myEmail(context,tokenResponse);
                break;
            default:
